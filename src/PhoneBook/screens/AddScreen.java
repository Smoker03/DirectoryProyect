...
public class AddScreen extends Screen{
    ...
    public AddScreen(Directory phoneDirectory){
        super(phoneDirectory);
    }

    public void Render(Directory directory){
        this.phoneDirectory = directory;
        ...
        //Setting a switch to create a new Contact depends on the contact selected
         switch (selectedTypeContact) {
            case "Regular" -> {
                ...
                this.phoneDirectory.addContact(new RegularContact(firstName, lastName, phoneNumber));
            }
            case "Privado" -> {
                ...
                this.phoneDirectory.addContact(new PrivateContact(firstName, lastName, phoneNumber));
            }
            case "Negocios" -> {
                ...
                this.phoneDirectory.addContact(new BusinessContact(firstName, lastName, phoneNumber, businessName));
            }
